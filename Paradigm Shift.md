---
created: Tuesday, November 1st 2022 - 10.41
updated: Tuesday, November 1st 2022 - 10.41
---
```HTML
				...
				<!-- Intro -->
					<section class="intro">
						<header>
							...
							<p>A nisl praesent arcu accumsan nascetur at luctus sed Interdum</p>
							<ul class="actions">
				...
				<!-- Section -->
					<section>
						...
						<div class="content">
							...
							<ul class="actions">
								<li><a class="button primary large" style="cursor: pointer;">Get Started</a></li>
								<li><a class="button large" style="cursor: pointer;">Learn More</a></li>
							</ul>
						</div>
					</section>
					...
					<section>
						...
						<footer>
							<ul class="items">
								<li>
									<h3>Email</h3>
									<a style="cursor: pointer;">information@untitled.ext</a>
								</li>
								<li>
									<h3>Phone</h3>
									<a style="cursor: pointer;">(000) 000-0000</a>
								</li>
								<li>
									<h3>Address</h3>
								...
								<li>
									...
									<ul class="icons">
										...
										<li><a class="icon brands fa-linkedin-in" style="cursor: pointer;"><span class="label">LinkedIn</span></a></li>
										<li><a class="icon brands fa-github" style="cursor: pointer;"><span class="label">GitHub</span></a></li>
										<li><a class="icon brands fa-codepen" style="cursor: pointer;"><span class="label">Codepen</span></a></li>
									</ul>
								</li>
							</ul>
						</footer>
